...
public class Config : MonoBehaviour
{
    ...
    public static int N = 2000;            // Number of particles
    ...
    public static float WALL_POS = 0.0000001f;  // Position adjustment for particles that are too close to the walls
    ...
    public static float K = SPACING / 100000.0f;  // Pressure factor
    ...
    public static float REST_DENSITY = 0.5f;
    ...
    public static float SIGMA = 0.9f;         // Viscosity factor
    public static float MAX_VEL = 18.75f;  // Maximum velocity of particles, used to avoid instability

    // Wall constraints factor, how much the particle is pushed away from the simulation walls
    public static float WALL_DAMP = 0.98f;
